...
|---------|----------|------|------------------|--------|-------|
| [trivy](https://github.com/aquasecurity/trivy) | Yes | Yes | GHCR, ECR Public, Docker Hub | Yes | [state/trivy.tsv](state/trivy.tsv) |
| [trivy-action](https://github.com/aquasecurity/trivy-action) | Yes | Yes | — | — | [state/trivy-action.tsv](state/trivy-action.tsv) |
| [setup-trivy](https://github.com/aquasecurity/setup-trivy) | Yes | Yes | — | — | [state/setup-trivy.tsv](state/setup-trivy.tsv) |
| [trivy-operator](https://github.com/aquasecurity/trivy-operator) | Yes | Yes | GHCR, Docker Hub | Yes | [state/trivy-operator.tsv](state/trivy-operator.tsv) |
| [kube-bench](https://github.com/aquasecurity/kube-bench) | Yes | Yes | Docker Hub | — | [state/kube-bench.tsv](state/kube-bench.tsv) |
